...
using Assessment.Health.Infrastructure.Mapping;
using Assessment.Health.Persistence;
using Assessment.Health.Service.Contract;
using Assessment.Health.Service.Implementation;
using AutoMapper;
...
namespace Assessment.Health.Infrastructure.Extension
{
    public static class ConfigureServiceContainer
    {
        ...
        public static void AddSwaggerOpenAPI(this IServiceCollection serviceCollection)
        {
            serviceCollection.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    ...
                    new OpenApiInfo()
                    {
                        Title = "Assessment Health WebAPI",
                        Version = "1",
                        Description = "Through this API you can access patient details",
                        Contact = new OpenApiContact()
                        {
                            Email = "femiisaac92@gmail.com",
                            Name = "Femi Isaac",
                            Url = new Uri("https://github.com/femiisaac92/")
                        },
        ...
        public static void AddHealthCheck(this IServiceCollection serviceCollection, AppSettings appSettings, IConfiguration configuration)
        {
            ...
            //    .AddUrlGroup(new Uri(appSettings.ApplicationDetail.ContactWebsite), name: "Assessment health website", failureStatus: HealthStatus.Degraded)
